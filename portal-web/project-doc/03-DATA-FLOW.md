...
| **geodns** | Go | 入口调度：健康视图同步、就近路由 | 15354(HTTP API) |
...
- **HTTP API (15354)**：接收节点选择请求，返回最优 resolver IP
...
| 日期 | 描述 |
|------|------|
| 2026-06-23 | 新增 GeoDNS 数据流说明，明确 GeoDNS 为 HTTP API (15354) 服务 |
