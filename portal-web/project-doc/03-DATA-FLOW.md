...
│  │  ProfileCache → profile.quota.quota_status                     │ │
...
│                          :53                                       │
│                                                                    │
│  1. 客户端 IP → 匹配 ProfileConfig 中的 devices                     │
│  2. 获取对应 profile_id                                           │
...
│  2. 从 ProfileConfig 匹配设备 IP → Profile   │
...
6. checksum 通过后，写入 ProfileCache（data/profiles/{prefix2}/{profileID}.json）
7. Resolver 热加载新配置
