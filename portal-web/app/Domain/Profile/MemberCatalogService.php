        ...
        return [
            ...
            'privacy_blocklists' => [
                [
                    ...
                    'system' => true,
                    'devices' => [
                        ['key' => 'windows', 'name' => 'Windows（所有版本）', 'icon' => '💻', 'enabled' => true],
                        ['key' => 'apple', 'name' => 'Apple（iOS、macOS、tvOS）', 'icon' => '🍎', 'enabled' => true],
                        ['key' => 'samsung', 'name' => 'Samsung（手机、平板电脑和智能电视）', 'icon' => '📱', 'enabled' => true],
                        ['key' => 'xiaomi', 'name' => '小米（手机、平板电脑、智能电视和路由器）', 'icon' => '📱', 'enabled' => true],
                        ['key' => 'huawei', 'name' => '华为（手机和平板电脑）', 'icon' => '📱', 'enabled' => true],
                        ['key' => 'amazon_alexa', 'name' => 'Amazon Alexa 助手', 'icon' => '🔊', 'enabled' => true],
                        ['key' => 'roku', 'name' => 'Roku（所有 Roku 机顶盒）', 'icon' => '📺', 'enabled' => true],
                        ['key' => 'sonos', 'name' => 'Sonos 音箱', 'icon' => '🔊', 'enabled' => true],
                    ],
                ],
            ...
            'parental_presets' => [
                ...
                [
                    ...
                    'url' => '',
                    'options' => [
                        ['name' => 'Facebook', 'icon' => '🌐', 'category' => 'website', 'desc' => '社交媒体平台', 'value' => 'https://www.facebook.com', 'enabled' => true],
                        ['name' => 'Instagram', 'icon' => '📷', 'category' => 'website', 'desc' => '照片和视频分享', 'value' => 'https://www.instagram.com', 'enabled' => true],
                        ['name' => 'TikTok', 'icon' => '🎵', 'category' => 'app', 'desc' => '短视频平台', 'value' => 'https://www.tiktok.com', 'enabled' => true],
                        ['name' => 'Twitter / X', 'icon' => '🐦', 'category' => 'website', 'desc' => '社交网络服务', 'value' => 'https://twitter.com', 'enabled' => true],
                        ['name' => 'Snapchat', 'icon' => '👻', 'category' => 'app', 'desc' => '多媒体即时通讯', 'value' => 'https://www.snapchat.com', 'enabled' => true],
                        ['name' => 'Discord', 'icon' => '💬', 'category' => 'app', 'desc' => '语音、视频和文字聊天', 'value' => 'https://discord.com', 'enabled' => true],
                        ['name' => 'YouTube', 'icon' => '▶️', 'category' => 'website', 'desc' => '在线视频平台', 'value' => 'https://www.youtube.com', 'enabled' => true],
                        ['name' => 'Twitch', 'icon' => '🎮', 'category' => 'website', 'desc' => '游戏直播平台', 'value' => 'https://www.twitch.tv', 'enabled' => true],
                        ['name' => 'Steam', 'icon' => '🎮', 'category' => 'game', 'desc' => 'PC 游戏平台', 'value' => 'https://store.steampowered.com', 'enabled' => true],
                        ['name' => 'Epic Games', 'icon' => '🎮', 'category' => 'game', 'desc' => '游戏商店与启动器', 'value' => 'https://www.epicgames.com', 'enabled' => true],
                        ['name' => 'Roblox', 'icon' => '🎮', 'category' => 'game', 'desc' => '在线游戏平台', 'value' => 'https://www.roblox.com', 'enabled' => true],
                    ],
                ],
            ],
        ];
