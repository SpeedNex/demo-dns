...
final class AdminMemberCatalogController
{
    ...
    public function update(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'device_models.*.field_type' => 'nullable|string|in:switch,multi',
            'device_models.*.options' => 'nullable|array',
            ...
            'privacy_blocklists.*.field_type' => 'nullable|string|in:switch,multi',
            'privacy_blocklists.*.options' => 'nullable|array',
            ...
            'parental_presets.*.key' => 'nullable|string|max:60',
            'parental_presets.*.name' => 'nullable|string|max:120',
            'parental_presets.*.desc' => 'nullable|string|max:500',
            'parental_presets.*.icon' => 'nullable|string|max:500',
            'parental_presets.*.field_type' => 'nullable|string|in:switch,multi',
            'parental_presets.*.options' => 'nullable|array',
            'parental_presets.*.category' => ['nullable', Rule::in(['website', 'app', 'game'])],
            'parental_presets.*.enabled' => 'nullable|boolean',
            'parental_presets.*.system' => 'nullable|boolean',
