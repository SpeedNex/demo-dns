...
- Control-plane to resolver integration is now verified end to end: `heartbeat -> config sync (Global Config + Lazy Profile) -> FetchProfile hot reload -> query resolution`.
