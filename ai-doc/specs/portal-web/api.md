...
```http
GET /api/v1/member/profiles/{profile_id}/rules?type=block&keyword=ads&page=1
```
...
```http
GET    /api/v1/member/profiles/{profile_id}/blocklist
POST   /api/v1/member/profiles/{profile_id}/blocklist
PUT    /api/v1/member/profiles/{profile_id}/blocklist/{rule_id}
DELETE /api/v1/member/profiles/{profile_id}/blocklist/{rule_id}
```
