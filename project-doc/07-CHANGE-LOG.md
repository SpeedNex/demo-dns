...
| 日期 | 类型 | 描述 | 涉及文件 | 状态 |
|---|---|---|---|---|
| 2026-07-08 | code | `/admin/rules/items` 列表返回规则源名称并在前端展示，修复规则条目未显示所属规则库的问题 | portal-web/app/Http/Controllers/Api/V1/Admin/AdminRuleItemController.php, portal-web/web/src/views/admin/RuleItems.vue, portal-web/web/src/locales/zh-CN.json, portal-web/web/src/locales/en.json, portal-web/web/src/locales/ko.json | ok |
